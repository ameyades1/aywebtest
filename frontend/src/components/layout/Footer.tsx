        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-white/80 text-sm">
              Reviving timeless knowledge of ancient scriptures for a transformed Bharat under the guidance of Jeevan Mukt Sadguru Acharya Upendra Ji.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-white/80 hover:text-primary transition-colors">About Acharya Upendra Ji</a>
              </li>
              <li>
                <a href="https://payment.antaryogfoundation.in/donation?_gl=1*1bnbpg7*_gcl_au*MTE5OTEwNzg0MC4xNzcxNjcyMzg1" className="text-white/80 hover:text-primary transition-colors">Donate</a>
              </li>
              <li>
                <a href="#" className="text-white/80 hover:text-primary transition-colors">Contact Us</a>
              </li>
              <li>
                <a href="https://learn.antaryogfoundation.in/p/press" className="text-white/80 hover:text-primary transition-colors">Newsroom</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-white/10 hover:bg-primary rounded-full flex items-center justify-center transition-all">
